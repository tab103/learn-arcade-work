...
def main():
    ...
    room = Room("You stand in a dark, dreary foyer. You note all the windows are boarded up. "
                ...
                " The door to your south is locked. There is a staircase to the North", 6, 5, None, 1)
    room_list.append(room)

    # Dining Room (1)
    room = Room("You are in what seems to be a dining room, the table you note is covered in rotten"
                " food and flies.\nYou can go North or East.", 2, 0, None, None)
    room_list.append(room)
    ...
    room = Room("You now stand in the laundry room which seems to be an irregularity throughout the house. The lights"
                " in this room are on and everything is organized with clothes seemingly \njust cleaned and ready to be"
    ...
    room = Room("You enter what seems to be a sitting room, it is as dark and unkept as the lobby with cobwebs covering"
                " most of the furniture, you note that there is one small chair that is \nabsent of all cobwebs. "
                "You can go North or West.", 4, None, None, 0)
    room_list.append(room)
    ...
    room = Room("As you enter a long hallway and you realize you can't see the end of it. You also see a "
                "door to the west. You can head further south to the other end of the hallway, through \nthe door or "
                "back to the staircase.", None, 6, 8, 10)
    room_list.append(room)

    # Lower Left Hall (8)
    room = Room("As you enter this part of the hall you notice another door to the west. The pitch black continues"
                " until you nearly walk into a wall marking the end of the hall. As you turn \naround you note"
                " there is a wall that wasn't there before marking a dead end, "
                "leaving only one direction to travel in: West.", None,
                None, None, 9)
    room_list.append(room)

    # Library (9)
    room = Room("As you enter the door shuts behind you. The room seems to be a library but for some reason all the"
                " books are on the floor, but one book remains on the northern bookshelf. You \nhave two options, go "
                "North and move the book or go East through the door", 10, 8, None, None)
    room_list.append(room)

    # Bedroom 1 (10)
    room = Room("You are now in what seems to be an old bedroom. You notice a small journal on the bed that has the"
                " same phrase written in it over and over \"HE'S COMING FOLLOW THE BLOOD\". \nYou see three doors, "
    ...
    room = Room("As you enter the bathroom you notice a victorian style doll sitting by the mirror pointing at the door"
                " you entered from. It's eyes follow you as you move. On the mirror \nwritten in blood is a message"
    ...
    room = Room("As you enter you hear a little girl calling to you from the room to the South saying to come to her."
                " Otherwise the room seems to have belonged to a young man but \non the ceiling you see marks "
                "that seem to have broken fingernails and blood, as if someone was dragged across it. "
                "You can only go in the door you came from to the West", None, None, None, 12)
    room_list.append(room)

    # Lower Right Hall (15)
    room = Room("The trail of blood leads to a door as you hear the voice of a little girl telling you to come inside"
                " and urging you to hurry before the monster gets you too. You can \ngo East to the little girl's voice"
    ...
    room = Room("As you enter you notice a translucent little girl standing by an open window. She calls to you and "
                "says \"If you want to escape you must jump out the window.\" This \nroom seems to be in good "
                "condition and there is nothing horrifying in it which is irregular noting what you have seen "
                "elsewhere. You can go East and jump out the window,"
                " or \nyou can go West back into the hallway", None, 17, None, 15)
    # Outside (17)
    room_list.append(room)
    outside = Room("As you land you hear scratching coming from within the walls of the house as it sounds "
                   "like something is trying to get out. As you flee the house you hear a "
                   "bloodcurdling \nroar come from the house, but nothing follows you further.", None, None, None, None)
    ...
    while not done:
        ...
        if insanity >= 20:
            print("You scream as a monstrous creature tears it way out of the wall and attacks you. It's eyeless head "
                  "roars in triumph as it tears you to pieces with it's long jagged claws \nand drags you into the wall"
                  " with it.")
