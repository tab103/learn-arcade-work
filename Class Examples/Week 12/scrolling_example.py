...
MOVEMENT_SPEED = 5
BOX_FILE = ":resources:images/tiles/boxCrate_double.png"
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        # Create the player
        self.player_sprite = arcade.Sprite(ROBOT, SPRITE_SCALING_PLAYER)
        ...
        wall = arcade.Sprite(BOX_FILE, SPRITE_SCALING_BOX)
        wall.center_x = 300
        wall.center_y = 200
