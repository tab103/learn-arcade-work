import arcade
import mycoollandscapelibrary
#import mycoollandascapelibrary as ll
...
def on_draw(delta_time):
    ...
    mycoollandscapelibrary.draw_grass(SCREEN_WIDTH, SCREEN_HEIGHT, arcade.csscolor.DARK_GREEN)
    draw_snow_person(on_draw.snow_person1_x, 140)
    draw_snow_person(450, 180) # stationary snow person
...
def main():
    ...
    # creates a refresh schedule where everything in the
    # on_draw function is done 60 times per second.
