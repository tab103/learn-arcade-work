...
class Player(pygame.sprite.Sprite):
	def __init__(self, pos_x, pos_y):
		...
		self.sprites = []
		self.sprites.append(pygame.image.load("attack1.jpg"))
		self.sprites.append(pygame.image.load("attack2.jpg"))
		self.sprites.append(pygame.image.load('attack3.jpg'))
		self.sprites.append(pygame.image.load('attack4.jpg'))
		self.sprites.append(pygame.image.load('attack5.jpg'))
